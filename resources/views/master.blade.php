...
<head>
    ...
    <style>
        ...
        .sidebar-collapsed .sidebar-text {
            ...
            width: 0;
            /* Tambahan: pastikan width text 0 agar tidak memakan tempat */
            display: none;
            /* Tambahan: sembunyikan dari flow */
        }
        ...
        .sidebar-collapsed ul li a {
            ...
            /* HAPUS padding 2.5rem yang bikin miring */
            padding-right: 0 !important;
            /* Pastikan kanan juga 0 */
        ...
        .tooltip::before {
            ...
            top: 50%;
            left: -5px;
            /* Position arrow on the left side */
...
<body class="bg-gray-50 min-h-screen flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ url('/') }}" class="flex ms-2.5 md:me-24">
                        ...
                        <span class="self-center text-lg font-semibold whitespace-nowrap text-gray-900">App
                            Pegawai</span>
                    </a>

                    <button data-drawer-target="top-bar-sidebar" data-drawer-toggle="top-bar-sidebar"
                        aria-controls="top-bar-sidebar" type="button"
                        class="inline-flex items-center p-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 border border-gray-300 mr-3"
                    ...
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button"
                                ...
                                <div
                                    class="w-8 h-8 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 flex items-center justify-center">
                        ...
                        <div class="z-50 hidden bg-white border border-gray-200 rounded-lg shadow-lg w-48"
                            id="dropdown-user">
                            ...
                            <ul class="p-2 text-sm text-gray-700 font-medium" role="none">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST" class="w-full">
                                        @csrf
                                        <button type="submit"
                                            class="inline-flex items-center w-full p-2 hover:bg-red-50 hover:text-red-600 rounded text-red-600"
                                            role="menuitem">
    ...
    <aside id="top-bar-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-full transition-all duration-300 ease-in-out -translate-x-full sm:translate-x-0"
        aria-label="Sidebar">
        <div class="h-full px-3 py-4 bg-white border-r border-gray-200">
            <div class="sidebar-logo flex items-center px-2 py-1.5 mb-3 rounded-lg">
                <svg class="sidebar-logo-icon w-5 h-5 flex-shrink-0 transition-all duration-300 text-gray-700"
                ...
                <span
                    class="sidebar-logo-text ms-3 text-lg text-gray-900 font-semibold whitespace-nowrap sidebar-text transition-opacity duration-300">App
                    Pegawai</span>
            </div>
            ...
            <ul class="space-y-2 font-medium mt-4">
                @can('isAdmin')
                    <li class="tooltip-container">
                        <a href="{{ url('/') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('/') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Dashboard">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('/') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                    ...
                    <li class="tooltip-container">
                        <a href="{{ url('/employees') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('employees*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Employees">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('employees*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                    ...
                    <li class="tooltip-container">
                        <a href="{{ url('/departments') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('departments*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Departments">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('departments*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M6 4h12M6 4v16M6 4H5m13 0v16m0-16h1m-1 16H6m12 0h1M6 20H5M9 7h1v1H9V7Zm5 0h1v1h-1V7Zm-5 4h1v1H9v-1Zm5 0h1v1h-1v-1Zm-3 4h2v1h-2v-1Z" />
                            </svg>
                    ...
                    <li class="tooltip-container">
                        <a href="{{ url('/positions') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('positions*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Positions">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('positions*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                    ...
                    <li class="tooltip-container">
                        <a href="{{ url('/salaries') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('salaries*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Salaries">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('salaries*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M8 17.345a4.76 4.76 0 0 0 2.558 1.618c2.274.589 4.512-.446 4.999-2.31.487-1.866-1.273-3.9-3.546-4.49-2.273-.59-4.034-2.623-3.547-4.488.487-1.865 2.724-2.899 4.998-2.31.982.236 1.87.793 2.538 1.592m-3.879 12.171V21m0-18v2.2" />
                            </svg>
                    ...
                    <li class="tooltip-container">
                        <a href="{{ url('/attendance') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('attendance*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Attendance">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('attendance*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                    ...
                    <li class="tooltip-container">
                        <a href="{{ url('/users') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->is('users*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Users">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->is('users*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                ...
                @can('isPegawai')
                    ...
                    <li class="tooltip-container">
                        <a href="{{ route('presensi.index') }}"
                            class="sidebar-item flex items-center px-2 py-1.5 {{ request()->routeIs('presensi.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700' }} rounded-lg hover:bg-blue-50 hover:text-blue-600 group"
                            data-tooltip="Presensi">
                            <svg class="sidebar-item-icon w-5 h-5 transition duration-75 {{ request()->routeIs('presensi.*') ? 'text-blue-600' : 'text-gray-500' }} group-hover:text-blue-600 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                            ...
                            <span class="ms-3 sidebar-text transition-opacity duration-300">Presensi</span>
                        </a>
                    </li>
                @endcan
            </ul>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                        <a href="{{ url('/employees/create') }}"
                            class="flex flex-col items-center p-3 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                        ...
                        <a href="{{ url('/departments/create') }}"
                            class="flex flex-col items-center p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
                        ...
                        <a href="{{ url('/positions/create') }}"
                            class="flex flex-col items-center p-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors">
                        ...
                        <a href="{{ url('/users/create') }}"
                            class="flex flex-col items-center p-3 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors">
                        ...
                        <a href="{{ url('/attendance') }}"
                            class="flex flex-col items-center p-3 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors">
                        ...
                        <a href="{{ url('/salaries') }}"
                            class="flex flex-col items-center p-3 bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(event) {
                if (window.innerWidth < 640 && !isCollapsed) {
                    ...
                    const isClickOnToggleButton = Array.from(toggleButtons).some(btn => btn.contains(event
                        .target));
